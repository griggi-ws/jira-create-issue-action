...
async function exec () {
  try {
    ...
    const response = await new CreateJiraIssueAction(inputs.jiraBaseUrl, inputs.project, inputs.issuetype, inputs.summary, inputs.description, inputs.labels.split(','), inputs.jiraToken).execute();
